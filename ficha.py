...
nome_completo = nome + " " + sobrenome # Concatena o nome e sobrenome com um espaço entre eles e armazena na variável 'nome_completo'
...
print(f"Nome Completo: {nome_completo}") # Imprime o nome completo do usuário, que é a combinação do nome e sobrenome
